...
namespace Narrowspark\Automatic\Skeleton\Common\Contract;
...
interface Container
{
     ...
     *
     * @throws \Narrowspark\Automatic\Skeleton\Common\Contract\Exception\InvalidArgumentException if no entry is found
     */
