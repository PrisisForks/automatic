...
namespace Narrowspark\Automatic\LegacyFilter\Common\Contract;
...
interface Container
{
     ...
     *
     * @throws \Narrowspark\Automatic\LegacyFilter\Common\Contract\Exception\InvalidArgumentException if no entry is found
     */
