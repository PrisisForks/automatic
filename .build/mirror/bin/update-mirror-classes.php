...
require $rootDir . '/../../vendor/symfony/filesystem/Exception/InvalidArgumentException.php';
...
require $rootDir . '/../../vendor/symfony/filesystem/Exception/FileNotFoundException.php';

require $rootDir . '/../../vendor/symfony/filesystem/Filesystem.php';

require $rootDir . '/../../tests/AutoReview/MirrorSettings.php';

use Narrowspark\Automatic\Tests\AutoReview\MirrorSettings;
